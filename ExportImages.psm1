...
Param
(
	[String]$filesdirectory =$(throw "Parameter missing: -filesdirectory filesdirectory"),
	[String]$DestinationFolder =$(throw "Parameter missing: -DestinationFolder DestinationFolder")
)

$tempDestinationFolder = "C:\Temp\DOCX"
$srcfiles = Get-ChildItem -Path $filesdirectory -Recurse -Include *.doc, *.rtf | where { $_.Length -gt 60KB}
...
ExportImages -filesdirectory 'Memo Tags 2' -DestinationFolder 'C:/Temp/images/'